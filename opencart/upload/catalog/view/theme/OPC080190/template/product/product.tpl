    ...
    <?php } ?>
		...
		<h1><?php echo $heading_title; ?></h1>
          ...
          <div id="product">
            ...
            <button type="button" class="btn btn-default compare" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product_id; ?>');"><i class="fa fa-area-chart"></i><?php echo $button_compare; ?></button>
          </div>
            ...
            <!-- AddThis Button END --> 
          <div class="content_product_block"><?php echo $productpage; ?> </div>
        </div>
		<?php if ($column_left && $column_right) { ?>
        <?php $class = 'col-sm-6'; ?>
        <?php } elseif ($column_left || $column_right) { ?>
