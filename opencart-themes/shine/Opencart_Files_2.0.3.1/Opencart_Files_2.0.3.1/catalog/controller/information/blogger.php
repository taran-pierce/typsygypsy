...
class ControllerInformationBlogger extends Controller {
	...
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/information/blogger.tpl')) {
			...
			$this->response->setOutput($this->load->view('default/template/information/blogger.tpl', $data));
		}
	}
	...
	public function blogs() {
			...
			if (!empty($setting['status']) && $setting['status']) {
				...
				$total_comments = $this->model_megnor_blogger->getTotalBlogComments($module_blog['blogger_id']);
					...
					$module_blog_data[] = array(
						...
						'date_added'  => date($this->language->get('date_format_long'), strtotime($module_blog['date_added'])),
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/information/blogger_blogs.tpl')) {
			...
			$this->response->setOutput($this->load->view('default/template/information/blogger_blogs.tpl', $data));
		}
	}
}