<div id="cart" class="btn-group btn-block">
  <div class="cart_button" data-toggle="dropdown" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-inverse btn-block btn-lg dropdown-toggle"><div id="cart-total"><?php echo $text_items; ?></div></div>
