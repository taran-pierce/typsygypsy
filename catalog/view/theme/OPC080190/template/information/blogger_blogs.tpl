...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="panel-default blog_page">
        <?php /*?><h3><?php echo $blog['name']; ?></h3><?php */?>
        ...
        <div class="panel panel-default">
		  ...
		  <div class="blog_title"><h5><a href="<?php echo $topic['href']; ?>"><?php echo $topic['title']; ?></a></h5></div>
		  </div>
            <div class="blog-desc"><?php echo $topic['description']; ?> </div>
			<div class="blog-date"> <i class="fa fa-calendar-o"></i><?php echo $topic['date_added']; ?></div>
			<div class="write-comment"> <i class="fa fa-comment"></i><a href="<?php echo $topic['href']; ?>"><?php echo $topic['total_comments']; ?> <?php echo $entry_comment; ?></a> </div>
