    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="category_filter">
        <div class="col-md-4 btn-list-grid">
          <div class="btn-group">
            <button type="button" id="grid-view" class="btn btn-default grid active" data-toggle="tooltip" title="<?php echo $button_grid; ?>"></button>
		  ...
		  <div class="product-block-inner">
            ...
            <div class="product-details">
              ...
              <div class="button-group">
                <button type="button" class="wishlist" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart"></i><?php echo $button_wishlist; ?></button>
				<span class="separator">|</span>
                <button type="button" class="compare" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-area-chart"></i><?php echo $button_compare; ?></button>
              </div>
            </div>
			</div>
          </div>
